...
/**
 * SettingsModal component for style and generation settings
 * @param {Object} props - Component props
 * @param {boolean} props.isOpen - Whether modal is open
 * @param {Function} props.onClose - Function to close modal
 * @param {Object} props.settings - Current style settings
 * @param {Function} props.onSettingsChange - Function to update settings
 * @returns {JSX.Element} SettingsModal component
 */
